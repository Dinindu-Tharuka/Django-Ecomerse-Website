...
from .serializers import ProductSerializer, CartItemUpdaterSerializer, CollectionSerializer, ReviewSerializer, CartSerializer, CartItemSerializer, SimpleCartItemSerializer
...
class CartItemViewSet(ModelViewSet):
    ...
    def get_serializer_class(self):
        if self.request.method == 'POST':
            ...
            return CartItemUpdaterSerializer
